...
#include "../../hittest1/cgraphicsview.h"
...
QT_MOC_LITERAL(4, 39, 10), // "mouseClick"
QT_MOC_LITERAL(5, 50, 14), // "mouseMoveEvent"
QT_MOC_LITERAL(6, 65, 15) // "mousePressEvent"

    },
    "CGraphicsView\0mouseMoved\0\0QMouseEvent*\0"
    "mouseClick\0mouseMoveEvent\0mousePressEvent"
};
...
void CGraphicsView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->mouseClick((*reinterpret_cast< QMouseEvent*(*)>(_a[1]))); break;
        ...
        {
            typedef void (CGraphicsView::*_t)(QMouseEvent * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CGraphicsView::mouseMoved)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (CGraphicsView::*_t)(QMouseEvent * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CGraphicsView::mouseClick)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void CGraphicsView::mouseMoved(QMouseEvent * _t1)
{
...
// SIGNAL 1
void CGraphicsView::mouseClick(QMouseEvent * _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
